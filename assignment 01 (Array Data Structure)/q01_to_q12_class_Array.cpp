...
public:                                                              //
    ...
    bool Is_Empty() { return last_index == -1 ? true : false; }      // 3.  In question 1, add a method to check whether an array is empty or not by returning True or False.
    ...
    bool Is_Full() { return last_index == size - 1 ? true : false; } // 8.  In question 1, define a method to check if the array is full by returning true or false.
