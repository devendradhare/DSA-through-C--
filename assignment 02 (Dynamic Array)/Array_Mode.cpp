...
int Array_Mode::gretest_elm()
{
    if (Is_Empty())
    {
        cout << "< get_element : Array is Empty >";
        return 0;
    }
...
int Array_Mode::smallest_elm()
{
    if (Is_Empty())
    {
        cout << "< smallest_elm : Array is Empty >";
        return 0;
    }
    int temp = get_element(0);
    for (int i = 1; i < no_of_elements(); i++)
...
void Array_Mode::rotate_right()
{
    if (Is_Empty())
    {
        cout << "< rotate_right : Array is Empty >";
        return;
    }
